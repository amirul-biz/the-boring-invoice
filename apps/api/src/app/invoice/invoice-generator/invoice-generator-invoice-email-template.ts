        ...
        <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 0 40px 32px; text-align: center;">
              <a href="${process.env.API_URL}/invoice/pay/${invoice.invoiceNo}" style="display: inline-block; background: linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%); color: #ffffff; text-decoration: none; padding: 16px 48px; border-radius: 8px; font-size: 16px; font-weight: 600; box-shadow: 0 4px 14px rgba(37, 99, 235, 0.4);">Pay Now</a>
...
PAY NOW
───────────────
${process.env.API_URL}/invoice/pay/${invoice.invoiceNo}
